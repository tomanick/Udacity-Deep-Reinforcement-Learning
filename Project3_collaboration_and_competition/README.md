...
The task is episodic, and in order to solve the environment, the score should surpass +0.5 in average of 100 consecutive episodes. 
...
`Tennis.ipynb` : This notebook contains the code to set up the environment and trains the agent to solve the reinforcement learning problem. My solution uses DDPG.
